...
1. [Architecture Overview](/Users/fzapata99/Documents/pain.exe/pain.exe/docs/architecture/overview.md)
2. [Event Loop](/Users/fzapata99/Documents/pain.exe/pain.exe/docs/architecture/event-loop.md)
3. [Data Model](/Users/fzapata99/Documents/pain.exe/pain.exe/docs/architecture/data-model.md)
4. Product docs in `docs/product/`
5. Integration docs in `docs/integrations/`
6. Operations docs in `docs/operations/`
7. [Demo Slice](/Users/fzapata99/Documents/pain.exe/pain.exe/docs/roadmap/demo-slice.md)
8. Milestone roadmap docs in `docs/roadmap/`

## Intent

Each doc is written as an implementation brief. They are meant to become tickets, interfaces, and acceptance criteria for the first build.
